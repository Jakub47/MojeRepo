...
namespace Blog.DAL
{
    public class BlogInitializer : DropCreateDatabaseAlways<BlogContext>
    {
        ...
        private void SeedBlogData(BlogContext context)
        {
            //POSTY
            ...
            posty.ForEach(a => context.Post.Add(a));
            try
            {
                context.SaveChanges();
            }
            ...
            komentarze.ForEach(a => context.Komentarz.Add(a));
            try
            {
                context.SaveChanges();
            }
            ...
            kategorie.ForEach(a => context.Kategoria.Add(a));
            try
            {
                context.SaveChanges();
            }
            ...
            kategoriePostu.ForEach(a => context.KategoriaPostu.Add(a));
            try
            {
                context.SaveChanges();
            }
